...
type SettingsUnion = DeepSeekSettings | DoubaoSettings | DoubaoSeedreamSettings | SiliconFlowSettings | CerebrasSettings | GroqSettings | GrokSettings | OpenRouterSettings | MistralSettings | GeminiSettings | DoubaoSeedanceSettings;
      ...
      {isSeedance && (
        <>
          <div className="setting-group">
            ...
            <select
              value={seedanceSettings.resolution || '720p'}
          ...
          <div className="setting-group">
            ...
            <select
              value={seedanceSettings.ratio || '16:9'}
          ...
          <div className="setting-group">
            ...
            <input
              ...
              min="2"
              max="12"
              value={seedanceSettings.duration || 5}
          ...
          <div className="setting-group">
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
              ...
              <input
                type="checkbox"
                checked={seedanceSettings.watermark || false}
            ...
            <>
              <div className="setting-group">
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                  ...
                  <input
                    type="checkbox"
                    checked={seedanceSettings.generate_audio ?? true}
              ...
              <div className="setting-group">
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                  ...
                  <input
                    type="checkbox"
                    checked={seedanceSettings.draft || false}
          ...
          <div className="setting-group">
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
              ...
              <input
                type="checkbox"
                checked={seedanceSettings.camera_fixed || false}
          ...
          <div className="setting-group">
            ...
            <input
              type="number"
              placeholder="-1"
              value={seedanceSettings.seed !== undefined ? seedanceSettings.seed : ''}
              onChange={(e) => {
                const val = e.target.value === '' ? undefined : parseInt(e.target.value);
                handleChange('seed', val);
              }}
